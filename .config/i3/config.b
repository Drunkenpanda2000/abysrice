...
bindsym $mod+z			gaps inner current set 10 ; gaps outer current set 10
bindsym $mod+Shift+z		gaps inner current set 65 ; gaps outer current set 0
...
# #---Function Buttons---# #
bindsym $mod+F1		exec wal -i ~/wallpapers/anime
...
exec_always --no-startup-id notify-send -i ~/.scripts/larbs.png '<b>Welcome to LARBS:</b> Press Super+F1 for the manual.' -t 10000
